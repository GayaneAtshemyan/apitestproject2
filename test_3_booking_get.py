...
#         assert 'firstname' in reponse_data, "The response does not contain 'firstname'"
#         assert 'lastname' in reponse_data, "The response does not contain 'lastname'"
#         assert 'bookingdates' in reponse_data, "The response does not contain 'bookingdates'"
#
